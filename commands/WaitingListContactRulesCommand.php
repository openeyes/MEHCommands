...
class WaitingListContactRulesCommand extends CConsoleCommand {
	public function run($args) {
		Yii::app()->db->createCommand("delete from ophtroperation_waiting_list_contact_rule")->query();

		$rule1 = new OphTrOperation_Waiting_List_Contact_Rule;
		...
		$rule = new OphTrOperation_Waiting_List_Contact_Rule;
		...
		$rule2 = new OphTrOperation_Waiting_List_Contact_Rule;
		...
		$rule3 = new OphTrOperation_Waiting_List_Contact_Rule;
		...
		$rule4 = new OphTrOperation_Waiting_List_Contact_Rule;
		...
		$rule5 = new OphTrOperation_Waiting_List_Contact_Rule;
		...
		$rule6 = new OphTrOperation_Waiting_List_Contact_Rule;
